...
<div class="groupes form large-10 medium-9 columns">
    ...
    <fieldset>
        ...
        echo $this->Form->input('obligatoire', [
            'label' => 'Les étudiants associés aux parcours de ce groupe doivent-être obligatoirement présents',
    ...
    <?= $this->Form->button(__('Modifier le groupe'), ['class' => 'btn, btn-primary']) ?>
    <?= $this->Form->end() ?>
</div>
