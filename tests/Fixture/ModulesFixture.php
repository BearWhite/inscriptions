...
class ModulesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_modules_periodes1_idx' => ['type' => 'index', 'columns' => ['periode_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_modules_periodes1' => ['type' => 'foreign', 'columns' => ['periode_id'], 'references' => ['periodes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
